          ...
          <Card className="p-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <a 
                  href="https://www.amazon.com/Nikon-D3500-NIKKOR-18-55mm-3-5-5-6G/dp/B07GWKDLGT?th=1&linkCode=ll1&tag=camerageargui-20&linkId=a988bdbdc251a57a680af71973ed9860&language=en_US&ref_=as_li_ss_tl" 
                  target="_blank" 
                  rel="nofollow noopener"
                  className="inline-block bg-primary text-primary-foreground px-4 py-2 rounded-md hover:bg-primary/90 transition-colors"
                >
