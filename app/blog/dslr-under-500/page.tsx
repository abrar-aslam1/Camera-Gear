...
export const metadata: Metadata = {
  ...
  keywords: ['DSLR cameras', 'budget cameras', 'Canon EOS Rebel T7', 'Nikon D3500', 'Pentax K-70', 'photography', 'camera guide', 'affordable cameras'],
};
...
const jsonLd = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://cameragear.com/blog/dslr-under-500'
  }
};
